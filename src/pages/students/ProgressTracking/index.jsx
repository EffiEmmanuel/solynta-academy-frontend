...
import StudentProgressTracking from "../../../components/ui/Student/Dashboard/StudentProgressTracking";

function StudentProgressTrackingPage() {
  ...
  return (
    <>
      <ToastContainer />
      {isUserLoggedIn && (
        <StudentDashboard page="progress-tracking">
          <div></div>
