...
import TeacherStudentMonitoring from "../../../components/ui/Teacher/Dashboard/TeacherStudentMonitoring";
import ParentDashboard from "../../../components/ui/Parent/Dashboard";
import ParentChildPerformance from "../../../components/ui/Parent/Dashboard/ParentChildPerformance";
...
function ChildPerformancePage() {
  ...
  return (
    <>
      <ToastContainer />
      {isUserLoggedIn && (
        <ParentDashboard page="childs-performance">
          <div></div>
