...
import ParentTeachersNote from "../../../components/ui/Parent/Dashboard/ParentTeachersNotes";

function TeachersNotesPage() {
  ...
  return (
    <>
      <ToastContainer />
      {isUserLoggedIn && (
        <ParentDashboard page="teachers-notes">
          <div></div>
          <ParentTeachersNote />
        </ParentDashboard>
      )}
...
export default TeachersNotesPage;
